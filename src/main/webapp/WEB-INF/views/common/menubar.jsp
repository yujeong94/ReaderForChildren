...
<body>
	...
	<header>
      <div class = "mainheader clear-fix">
         ...
         <ul class='util'>
         	<li><img src = "${ contextPath }/resources/images/cart.png" width = 40px height = 40px></li>
      ...
      <div id="menuShow" class="menulist">
			...
			<a href="#">오디오북 shop</a>
			<a href="${ contextPath }/views/sponser/sponser1.jsp">아동 후원</a> 
			<a href="#">봉사 일정</a>
...
<body>
	...
	<header>
      ...
      <div id="menuShow" class="menulist">
			<a href="#" class="closeBtn" onclick="closeMenu();">X</a>
			<a href="${ contextPath }/views/audioBook/audioBookList.jsp">오디오북 shop</a>
			<a href="#">아동 후원</a>
			<a href="#">봉사 일정</a>
			<a href="${ contextPath }/views/audition_yj/auditionList.jsp">Reader 오디션 지원</a>
			<a href="#">녹음부스 예약</a>
