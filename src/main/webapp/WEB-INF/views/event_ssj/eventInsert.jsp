	...
	<div class="contents">
		...
		<table class="tableStyle">
			<tr>
				...
				<td>
					<input type="text" class="inputStyle" name="evnet_title" id="evnet_title" placeholder="이벤트 제목을 입력하세요.">
				</td>
			</tr>
			<tr>
				<td class="label" id="labelTd">기간</td>
				<td>
					<input type="date" class="inputStyle" name="startDate" id="startDate">
					~
					<input type="date" class="inputStyle" name="eneDate" id="eneDate">
				</td>
			</tr>
			<tr>
				<td class="label" id="labelTd">발표 날짜</td>
				<td>
					<input type="date" class="inputStyle" name="announDate" id="announDate">
				</td>
			</tr>
			<tr>
				<td class="label" id="labelTd">대상자</td>
				<td>
					<select size="1" id="event_entry">
			...
			<tr>
				...
				<td>
					<input type="number" min="1" id="event_num">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2"><textarea class="textClass" name="event_intro" id="event_intro" rows="7" cols="110" placeholder="이벤트 소개를 적어주세요."></textarea></td>
			</tr>
			<tr>
				<td colspan="2" class="label" id="labelTd1">이벤트 참여 방법</td>
			</tr>
			<tr>
				<td colspan="2"><textarea class="textClass" name="event_way" id="event_way" rows="7" cols="110" placeholder="이벤트 참여 방법을 적어주세요."></textarea></td>
			</tr>
			<tr>
				<td colspan="2" class="label" id="labelTd1">이벤트 당첨 기준</td>
			</tr>
			<tr>
				<td colspan="2"><textarea class="textClass" name="event_stand" id="event_stand" rows="7" cols="110" placeholder="이벤트 당첨 기준을 적어주세요."></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="btnStyle"><button class="defaultBtn upBtn">등록</button></td>
			</tr>
		</table>
	</div>
