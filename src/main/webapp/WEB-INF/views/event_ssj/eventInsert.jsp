		...
		<form action="eventDataInsert.ev" method="post" enctype="Multipart/form-data" onsubmit="return submitForm();">
			...
			<table class="tableStyle">
				...
				<tr>
					...
					<td>
						<input type="date" class="inputStyle" min="${ nowDate }" name="eStart" id="startDate" required>
						~
						<input type="date" class="inputStyle" min="${ nowDate }" name="eEnd" id="endDate" required>
					</td>
				</tr>
				<tr>
					<td class="label" id="labelTd">발표 날짜</td>
					<td>
						<input type="date" class="inputStyle" min="${ nowDate }" name="eAnno" id="announDate" required>
					</td>
				</tr>
				<tr>
